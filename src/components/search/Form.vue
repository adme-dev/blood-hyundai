<template>
  <div
    id="modal-enquire"
    uk-modal
    class="modal-enquire uk-modal uk-open"
    style="display: block;opacity: 1;"
  >
    <div
      class="uk-modal-dialog uk-modal-body uk-background-default uk-box-shadow-medium uk-padding-remove"
    ...
    >
      <a
        @click="
          ...
          close();
        "
        class="uk-link-toggle enquire-header uk-flex uk-flex-middle view-form-header uk-background-secondary"
      >
      ...
      <div class="uk-padding-remove-top car-sales-from">
        <div class="uk-grid-collapse uk-padding-small uk-background-secondary uk-light" uk-grid>
          <div class="uk-width-expand uk-text-left">
            <h1 class="uk-h5 uk-margin-remove uk-text-truncate title-items">
              {{ item.year.displayValue[0] }}
              <span class="uk-text-bold"
                >{{ item.make.displayValue[0] }} {{ item.model.displayValue[0] }}</span
              >
            </h1>
        ...
        <ul class="uk-switcher uk-background-default uk-position-relative">
          <li class="uk-padding enqform">
            ...
            <form class="adne-form">
              <div
                class="uk-overlay form-overlay-default uk-width-1-1 uk-height-1-1 uk-position-top-left"
                v-show="isSending"
              >
              ...
              <div class="uk-margin-small uk-grid-small uk-child-width-auto uk-grid">
                <label class="uk-margin-small-left uk-margin-auto-right"
            ...
            >
              <div class="uk-position-center uk-text-center form-confirmation">
                ...
                <button
                  class="uk-button uk-button-primary uk-button-large uk-margin-small-top uk-hidden"
                  @click="close()"
                >
                  OK
                </button>
        ...
        axios
          .post(`${process.env.VUE_APP_PUBLIC_API_URL}/form`, {
            payload: {
              ...
              input_5: this.stockid,
              input_6: this.finance,
              input_7: this.tradein,
              input_8: this.condition,
              input_9: this.make,
              input_10: this.model,
              input_11: this.badge,
              input_15: this.item.locationID,
              input_16: this.testdrive,
            },
            formid: this.$store.state.site.forms.enquiry,
          })
          .then((response) => {
