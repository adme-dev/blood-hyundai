<template>
  <div class="uk-position-relative data-465763-navigation data-nav pnd">
    <div class="linear-activity" v-show="loading">
      <div class="indeterminate"></div>
    </div>

    <div class="uk-navbar-container uk-visible@m uk-navbar-transparent tm-toolbar-container">
              ...
              <li>
                <div class="uk-navbar-item uk-visible@l">
                  <a href="/contact" class="uk-link-reset">
                    ...
                    <span class="uk-button uk-button-text"><b>Open Hours</b></span>
                  </a>
    ...
    <div uk-sticky="top:800" show-on-up animation="uk-animation-slide-top"
      ...
      <div id="main-navbar" class="main-navbar" @mouseover="isHoveringNav = true" @mouseleave="isHoveringNav = false">
        <nav class="uk-navbar uk-container uk-container-large"
          uk-navbar="dropbar: true; dropbar-anchor: !.uk-navbar-container; target-y: !.data-nav">
          <div class="uk-navbar-left navbar-logo">
            <ul class="uk-navbar-nav">
              <li>
                <router-link :to="'/'" rel="home">
                  <img src="/assets/logos/logo-black.svg" width="160" height="22" class="nav-logo uk-visible@s"
                    loading="eager" :alt="siteName" />
                  <img data-src="/assets/logos/logo-black-sm.svg" width="50" height="26" class="nav-logo uk-hidden@s"
                    data-uk-img :alt="siteName" />
      ...
      siteName
          ...
          <div class="uk-navbar-right navbar-right uk-visible@l">
            <ul class="uk-navbar-nav navbar-address">
              <li>
          ...
          <div class="uk-navbar-right uk-hidden@l">
            <ul class="uk-navbar-nav">
              ...
              <li>
                <div class="uk-flex uk-flex-middle uk-height-1-1"><a href="#modal-call" uk-toggle
                    class="icon-phone uk-icon-button forcelink" title="Phone"><svg width="20" height="20"
                      viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="receiver">
...
const saveVehicleMenuItem = () => import('@/components/search/CarSales/saveVehicleMenuItem')
const GoogleReviewHeader = () => import(/* webpackPrefetch: true */ "@/components/google-reviews/GoogleReviewHeader");
export default {
  name: "primary-nav",
  components: { HeaderHours, Models, saveVehicleMenuItem, GoogleReviewHeader },
  data: function () {
    return {
...
.dropdown-show.background-white .mb-toolbar-gradient,
