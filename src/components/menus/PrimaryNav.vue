      ...
      <div class="uk-container uk-container-large uk-navbar" uk-navbar>
        ...
        <div class="uk-navbar-right">
          <nav>
            <ul class="uk-navbar-nav">
              <li>
                <a href="https://consumer.xtime.net.au/scheduling/?&webKey=ahy20140925h3222v&bx=470928&VARIANT=HYUNDAIAUSTRALIA&WMODE=true&bx1=470928#/" title="Vehicle servicing" target="_blank"><b class="uk-button uk-button-text pulse-button">Book a
                    Service</b></a>
              </li>
                          <li>
