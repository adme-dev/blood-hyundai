<template>
  <div class="contact-form uk-padding-small">
    <div class="uk-text-center uk-margin-medium-top">
      <p class="space33">{{ siteName }}</p>
      <div class="uk-h2 uk-text-uppercase uk-margin-remove">Register your interest</div>
    </div>
                ...
                <fieldset class="uk-fieldset uk-grid-small uk-grid">
                  ...
                  <div class="uk-width-1-1">
                    <p class="uk-text-meta uk-margin-small-top">
                      ...
                      <a class="uk-text-primary" href="/privacy-policy" target="_blank">Privacy Policy</a>. Our Privacy
                      Policy
                      contains details on how information is used, how you may access / correct information held and our
                      privacy
